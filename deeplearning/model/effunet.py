...
#Reference: https://github.com/LovreAB17/Eff-UNet/blob/main/models/EffUNet.py
...
class EffUNet(nn.Module):
    ...
    def __init__(self, model_id, project_dir, in_channels=3, classes=4):
        super().__init__()
    ...
    def forward(self, x):
        ...
        x5 = F.interpolate(x5, scale_factor=1.875)
        print(x5.shape)
